...
class Jadu:
    def __init__(self):
        self.name = '자두'
        self.director = []
        self.director.append(meditite.Meditite())
        self.director.append(machoke.Machoke())
        self.director.append(lucario.Lucario())

        #강석의 포켓몬 레벨 조정
        self.director[0].level = 28
        self.director[1].level = 29
        self.director[2].level = 32
